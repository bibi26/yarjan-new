...
<div class="row" style="border-top: 3px #00CCFF solid;box-shadow: 0 2px 3px rgba(0,0,0,.12);background-color: white;height: 52px !important;">
    <style>
        ...
        .mega-dropdown-menu .dropdown-header {http://test.test/
            color: #428bca;
            font-size: 18px;
            font-weight:bold;
        }
        ...
        <div class="container">
            ...
            <div id="slidemenu">
                ...
                <ul class="nav navbar-nav" id="top_menu">
                    ...
                    <li id="contactTopMenu" ><a href="{{url('contactUs')}}"><span ><i style="color: #00CCFF;" class="fa fa-envelope"></i>&nbsp;</span>تماس با ما</a></li>
                ...
                <ul class="nav navbar-nav navbar-left" >
                    ...
                    @if (Cookie::get('LOGEDIN') == false)
                        <li id="signInTopMenu"><a href="{{url('signIn')}}" style="color:#000;"><span ><i style="color: #00CCFF;" class="fa fa-key"></i>&nbsp;</span></span>ورود</a></li>
                        <li id="signUpTopMenu"><a href="{{url('signUp')}}" style="color:#000;"><span ><i style="color: #00CCFF;" class="fa fa-user-plus"></i>&nbsp;</span>ثبت نام</a></li>
                            ...
                            <ul class="dropdown-menu mega-dropdown-menu row">
                                ...
                                <li class="col-lg-8">
                                    <ul>
                                        ...
                                        <li class="divider"></li>
                                        <li class="dropdown-header" id="signUpTopMenu9"><a href="{{url('signOut')}}" ><span ><i style="color: #00CCFF;" class="fa fa-times"></i>&nbsp;</span>خروج</a></li>
