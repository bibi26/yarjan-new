                                ...
                                {!! Form::open(['route'=>'forgetPass.store','style'=>'padding: 10px','id'=>'forgetPassForm']) !!}
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-default btn-send pull-left btn_green">
                                            <span><i class="fa fa-envelope"></i>&nbsp;</span>ارسال
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs">
                <div class="row" style="    border-right: 10px solid transparent; ">
                 ...
                 box-shadow: 0px 2px 18px -5px rgba(0,0,0,0.75); background-color: white;line-height: 2;text-align: justify;padding: 10px;">
                        <p><span style="color: #33d346;font-size: 18px;font-weight: bold;">&check;&nbsp;</span>خدمات
                            سایت
                        ...
                        <p><span style="color: #33d346;font-size: 18px;font-weight: bold;">&check;&nbsp;</span>شماره
                            همراه
