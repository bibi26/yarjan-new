...
>>>>>>> 7b9e93aee475cc53341b5c534ef571b8c5f33733
                                ...
                                @if(user()['role']=='admin' )
                                    ...
                                    @if($person['confirm']=='accept' )
                                        <div style="margin: 5px;">
                                            <label class="btn btn-success" style="width: 210px;text-align: right;">&nbsp;تایید
                                                شده </label>
                                        </div>
                                    @endif
                                    @if($person['confirm']=='reject' )
                                        <div style="margin: 5px;">
                                            <label class="btn btn-danger" style="width: 210px;text-align: right;">&nbsp;رد
                                                شده </label>
                                        </div>
                                    @endif
                                @endif
            ...
            <div class=" col-lg-12">
                <div class="tab" role="tabpanel" style="background-color: white;">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#Section2" data-toggle="tab" role="tab">معیارهای ازدواج</a>
                        </li>
