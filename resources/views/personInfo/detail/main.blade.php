                    ...
                    <div class="panel-body">
                        <div class="row ">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div style="margin: 5px;">
                                    <a class="btn btn-default" href="#" data-toggle="modal"
                                       data-target="#violationReportModal"
                                ...
                                <div style="margin: 5px;">
                                    <div>
                                        <small>کد شناسایی :</small>&nbsp;<b
                                            style="font-size: 18px;">{{$person['id']}}</b>
                                    </div>
                                    <div>
                                        <small>آخرین ورود :</small>&nbsp;<b
                                            style="font-size: 18px;">{{$person['last_visit']}}</b>
                                    </div>
                                    @if(user()['role']=='admin' )
                                        <hr/>
                                        <table>
                                        ...
                                        @endif
                                        @if($person['confirm']=='accept' )
                                            <div style="margin: 5px;">
                                                <h3 style="color: #00cc00;"><span>&check; &nbsp;</span>تایید</h3>
                                            </div>
                                        @endif
                                        ...
                                        @if($person['active']==1 )
                                            <div style="margin: 5px;">
                                                <h3 style="color: #00cc00;"><span>&check; &nbsp;</span>فعال</h3>
                                            </div>
                                        @endif
                                        @if($person['active']==0 )
                                            <div style="margin: 5px;">
                                        ...
                                        <div style="margin: 5px;">
                                            <a class="btn btn-info" href="#" data-toggle="modal"
                                               data-target="#deactiveUser"
                                               style="width: 210px;text-align: right;">&nbsp;فعال / غیرفعال
                                            </a>
                                        </div>
                    ...
                    <div class=" col-lg-12">
                        <div class="tab" role="tabpanel" style="background-color: white;">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation"><a href="#Section1" data-toggle="tab" role="tab">درباره من</a>
                                </li>
                                <li role="presentation"><a href="#Section2" data-toggle="tab" role="tab">معیارهای
                                        ازدواج</a>
                                </li>
                                <li role="presentation"><a href="#Section3" data-toggle="tab" role="tab">آلبوم عکس
                                        ها</a></li>
                            </ul>
                            <!-- Tab panes -->
