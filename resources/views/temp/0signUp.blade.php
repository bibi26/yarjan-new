                    ...
                    <div class="col-lg-12" id="dv_sign">
                        <div class="row">
                            <div class="col-lg-12"
                                ...
                                <span
                                    style="font-weight: bold;color: white;font-size: 18px;">لطفا  ثبت نام نمایید</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div
                                    style='text-align:center;color: red; font-size: 14px;min-height: 40px;padding-top: 10px;'
                                    id="alert_warn"></div>

                                {!! Form::open(['route'=>'contactus.store','style'=>'padding-top: 20px','id'=>'signUpForm']) !!}
                                ...
                                <div class="form-group {{ $errors->has('pass1') ? 'has-error' : '' }}">
                                    {!! Form::label(' رمز عبور :','',['class' => 'required']) !!}
                                    {!! Form::text('pass1','', ['class'=>'form-control','style'=>'direction: ltr']) !!}
                                    <span class="text-danger">{{ $errors->first('pass1') }}</span>
                                </div>
                                <div class="form-group  {{ $errors->has('pass2') ? 'has-error' : '' }}">
                                    {!! Form::label('  تکرار رمز عبور :','',['class' => 'required']) !!}
                                    {!! Form::text('pass2','' , ['class'=>'form-control','style'=>'direction: ltr']) !!}
                                ...
                                <div class="form-group">
                                    <a class="btn btn-default btn-send pull-left btn_sign_up"
                                       href="javascript:void(0);"
                                       onclick="javascrit:send(false)"><span><i
                                                class="fa fa-user-plus"></i>&nbsp;</span>ثبت
                                        نام رایگان </a>
                                </div>
<br/>
<br/>
