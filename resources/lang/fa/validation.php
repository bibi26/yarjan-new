...
return [
    ...
    */
    'custom' => [
        'accept_terms' => 'لطفا مطالعه و موافقت نمایید.',
    ...
    */
    'attributes' => [
        ...
        'hair_color' => 'رنگ مو',
        'eye_color' => 'رنگ چشم',
        'job_status' => 'وضعیت اشتغال',
        'job' => 'شغل',
        'marriage' => 'وضعیت ازدواج',
        'education' => 'تحصیلات',
        'field' => 'رشته تحصیلی',
        'my_income' => 'میزان درآمد شما',
        'family_income' => 'میزان درآمد خانواده',
        'house' => 'وضعیت مسکن',
        'car' => 'وضعیت اتومبیل',
        'child_count' => 'تعداد فرزندانم',
        'age_older_child' => 'سن فرزند بزرگترم',
        'weight' => 'وزن',
        'height' => 'قد',
        'skin_color' => 'رنگ پوست',
        'belief' => 'میزان اعتقادات',
        'health_condition' => 'وضعیت سلامتی',
        'immigration' => 'قصد مهاجرت به خارج',
        'face' => 'زیبایی',
        'style' => 'تیپ',
        'nationality' => 'قومیت',
        'life_style' => 'شیوه زندگی',
        'i_am' => 'من چنین هستم',
        'you_are' => 'همسرم چنین باشد',
